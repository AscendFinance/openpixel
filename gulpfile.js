...
var PIXEL_ENDPOINT     = process.env.OPIX_PIXEL_ENDPOINT || 'https://tracker.coverrightmedicare.com/pixel.gif';

// The core openpixel.min.js file that the snippet will loaded asynchronously into the browser
var JS_ENDPOINT        = process.env.OPIX_JS_ENDPOINT || 'https://tracker.coverrightmedicare.com/openpixel.js';
